...
const nombre = prompt ('Ingresa tu nombre y participa por un premio: ');
...
while (chances != 0) {
    ...
    if (numGanador==numElegido) {
        alert('¡¡¡Ganaste!!! Tenemos un mes de prueba gratis de Tu Gestión FULL. Enviaremos todo al correo que nos proporcionaste.');
        chances--
        ganador = true;
        break;
